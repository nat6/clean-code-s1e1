...
var createNewTaskElement = function (taskString) {
    ...
    label.className = "label-elem todo__label todo__task";
    ...
    editInput.type = "text";
    editInput.className = "input input_text todo__input todo__task";

    editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
    editButton.className = "button todo__button todo__button_edit";

    deleteButton.className = "button todo__button todo__button_delete";
...
var editTask = function () {
    ...
    var label = listItem.querySelector(".label-elem");
